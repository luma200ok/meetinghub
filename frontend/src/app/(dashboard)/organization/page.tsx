      ...
      <section className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          <form onSubmit={createDepartment} className="flex flex-col gap-3 rounded-lg border border-slate-200 bg-white p-5">
            ...
            <button className="rounded-md bg-slate-950 px-4 py-2 text-sm font-semibold text-white">추가</button>
          </form>
          ...
          <form onSubmit={createPosition} className="flex flex-col gap-3 rounded-lg border border-slate-200 bg-white p-5">
            ...
            <input className="rounded-md border border-slate-300 px-3 py-2 text-sm" placeholder="레벨" type="number" value={positionLevel} onChange={(event) => setPositionLevel(event.target.value)} />
            <button className="rounded-md bg-slate-950 px-4 py-2 text-sm font-semibold text-white">추가</button>
          </form>
          ...
          <form onSubmit={inviteMember} className="flex flex-col gap-3 rounded-lg border border-slate-200 bg-white p-5">
            ...
            <button className="rounded-md bg-slate-950 px-4 py-2 text-sm font-semibold text-white">초대 생성</button>
          </form>
        </div>
