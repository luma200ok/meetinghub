...
# 이 계정: gemini-2.0-flash=무료쿼터0(429), gemini-1.5-flash=미존재(404).
# flash-lite 는 별도 무료 쿼터 풀이라 시도. Render 의 AI_MODEL 로 override 가능.
_GEMINI_DEFAULT_MODEL = "gemini-2.0-flash-lite"
